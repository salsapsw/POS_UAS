...
import 'package:pos_uas/controllers/logout_controller.dart';
...
import 'package:pos_uas/views/produk_detail.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: ListView(
          children: [
            ListTile(
              ...
              onTap: () async {
                await LogoutController.logout().then((value) => {
      ...
      body: FutureBuilder<List>(
        future: ProdukController.getProduks(),
